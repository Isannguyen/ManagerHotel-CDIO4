    ...
    <div class="row">
        <div class="col-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="pt-3"><b>Thêm Mới Thuê Phòng</b></h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
        ...
        <div class="col-8">
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-header">
                    <h5 class="pt-3"><b>Danh Sách Thuê Phòng</b></h5>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center align-middle text-nowrap">
                                        <button class="btn btn-success" style="width: 150px;">Đã Thanh Toán</button>
                                    </td>
                                    <td class="text-center align-middle text-nowrap">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Cập Nhật Thuê Phòng</h1>
                    ...
                    <div class="modal fade" id="xoaModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Xóa Thuê Phòng</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="alert alert-warning border-0 bg-warning alert-dismissible fade show py-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <div class="text-dark">
                                                    <p>Bạn có muốn xóa sản phẩm <b> thuê phòng </b> này không?</p>
                                                    <p>
