        ...
        <div class="col-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="pt-3 text-dark"><b>Thêm Mới Hóa Đơn</b></h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <label for="">Ngày Xuất Hóa Đơn</label>
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-primary text-dark">Thêm Mới</button>
                </div>
            </div>
        </div>
        <div class="col-8">
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-header">
                    <h5 class="pt-3 text-dark"><b>Danh Sách Hóa Đơn</b></h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Cập Nhật Hóa Đơn</h1>
                                    ...
                                    <div class="alert alert-warning border-0 bg-warning alert-dismissible fade show py-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <div class="text-dark">
                                                    <p>Bạn có muốn xóa sản phẩm <b> hóa đơn </b> này không?</p>
                                                    <p>
